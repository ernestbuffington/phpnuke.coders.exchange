...
define_once("_SEARCH","Sök");
define_once("_LOGIN","Logga in");
define_once("_WRITES","skriver");
define_once("_POSTEDON","Postad");
define_once("_NICKNAME","Alias");
define_once("_PASSWORD","Lösenord");
define_once("_WELCOMETO","Välkommen till");
define_once("_EDIT","Redigera");
define_once("_DELETE","Radera");
define_once("_POSTEDBY","Postad av");
define_once("_READS","läsningar");
define_once("_GOBACK","[ <a href=\"javascript:history.go(-1)\">Gå Tillbaka</a> ]");
define_once("_COMMENTS","kommentarer");
define_once("_PASTARTICLES","Föregående Artiklar");
define_once("_OLDERARTICLES","Äldre Artiklar");
define_once("_BY","av");
define_once("_ON"," ");
define_once("_LOGOUT","Logga ut");
define_once("_WAITINGCONT","Väntande Innehåll");
define_once("_SUBMISSIONS","Postningar");
define_once("_WREVIEWS","Recensioner");
define_once("_WLINKS","Länkar");
define_once("_EPHEMERIDS","Dagens Ord");
define_once("_ONEDAY","På en dag som denna...");
define_once("_ASREGISTERED","Har du inget medlemskap än? Du kan <a href=\"modules.php?name=Your_Account\">bli medlem</a>. Som registrerad medlem har du lite fördelar som en temaväljare, kommentarsinställningar och möjligheten att skriva kommentarer under ditt eget namn.");
define_once("_MENUFOR","Meny för");
define_once("_NOBIGSTORY","Det finns inget Het Nyhet för Dagen, ännu.");
define_once("_BIGSTORY","Dagens mest lästa Nyhet är:");
define_once("_SURVEY","Undersökning");
define_once("_POLLS","Undersökningar");
define_once("_PCOMMENTS","Kommentarer:");
define_once("_RESULTS","Resultat");
define_once("_HREADMORE","läs mer...");
define_once("_CURRENTLY","Det finns för närvarande,");
define_once("_GUESTS","gäst(er) och");
define_once("_MEMBERS","medlem(mar) som är online.");
define_once("_YOUARELOGGED","Du är inloggad som");
define_once("_YOUHAVE","Du har");
define_once("_PRIVATEMSG","privata meddelanden.");
define_once("_YOUAREANON","Du är en anonym besökare. Du kan registrera dig gratis genom att fylla i detta <a href=\"modules.php?name=Your_Account\">formulär</a>");
define_once("_NOTE","Notera:");
define_once("_ADMIN","Admin:");
define_once("_WERECEIVED","Vi har haft");
define_once("_PAGESVIEWS","sidvisningar sedan");
define_once("_TOPIC","Ämne det ska postas under");
define_once("_UDOWNLOADS","Nedladdningar");
define_once("_VOTE","Rösta");
define_once("_VOTES","Röster");
define_once("_MVIEWADMIN","Vy: Endast Administratörer");
define_once("_MVIEWUSERS","Vy: Endast Medlemmar");
define_once("_MVIEWANON","Vy: Endast Anonyma besökare");
define_once("_MVIEWALL","Vy: Alla Besökare");
define_once("_EXPIRELESSHOUR","Förfaller inom en timme");
define_once("_EXPIREIN","Förfaller om");
define_once("_HTTPREFERERS","Vilkar länkar till oss");
define_once("_UNLIMITED","Obegränsat");
define_once("_HOURS","Timmar");
define_once("_RSSPROBLEM","Det är för närvarande problem med rubriker från denna webbplats");
define_once("_SELECTLANGUAGE","Välj Språk");
define_once("_SELECTGUILANG","Välj Språk för gränssnitt:");
