...
define_once("_SEARCH","Hae");
define_once("_LOGIN","Kirjaudu sisään");
define_once("_WRITES","kirjoitti:");
define_once("_POSTEDON","Kirjoitettu");
define_once("_NICKNAME","Käyttäjätunnus");
define_once("_PASSWORD","Salasana");
define_once("_WELCOMETO","Tervetuloa");
define_once("_EDIT","Muokkaa");
define_once("_DELETE","Poista");
define_once("_POSTEDBY","Hyväksyi:");
define_once("_READS","kertaa luettu");
define_once("_GOBACK","[ <a href=\"javascript:history.go(-1)\">Takaisin</a> ]");
define_once("_COMMENTS","kommentit"); 
define_once("_PASTARTICLES","Vanhat artikkelit"); 
define_once("_OLDERARTICLES","Vanhemmat artikkelit"); 
define_once("_BY","Kuka:");
define_once("_ON","Milloin:");
define_once("_LOGOUT","Kirjaudu ulos");
define_once("_WAITINGCONT","Odottava sisältö");
define_once("_SUBMISSIONS","Uutisia");
define_once("_WREVIEWS","Arvostelut");
define_once("_WLINKS","Linkkejä");
define_once("_EPHEMERIDS","Historiassa");
define_once("_ONEDAY","Päivä kuin tämä...");
define_once("_ASREGISTERED","Ole hyvä ja <a href=\"modules.php?name=Your_Account&op=new_user\">rekisteröidy</a>.");
define_once("_MENUFOR","Valikko");
define_once("_NOBIGSTORY","Päivälle ei ole vielä luetuinta uutista.");
define_once("_BIGSTORY","Päivän luetuin artikkeli:");
define_once("_SURVEY","Äänestys");
define_once("_POLLS","Kyselyt");
define_once("_PCOMMENTS","Kommentit:");
define_once("_RESULTS","Tulokset");
define_once("_HREADMORE","Lue lisää...");
define_once("_CURRENTLY","Sivustolla on parhaillaan,");
define_once("_GUESTS","vierasta ja");
define_once("_MEMBERS","jäsentä Online.");
define_once("_YOUARELOGGED","Olet kirjautunut:");
define_once("_YOUHAVE","Sinulla on");
define_once("_PRIVATEMSG","yksityisviestiä.");
define_once("_YOUAREANON","Olet anonyymi. Rekisteröidy <a href=\"modules.php?name=Your_Account&op=new_user\">jäseneksi</a>");
define_once("_NOTE","Viesti:");
define_once("_ADMIN","Ylläpitäjä:");
define_once("_WERECEIVED","Sivulatauksia");
define_once("_PAGESVIEWS","sitten");
define_once("_TOPIC","Kanava");
define_once("_UDOWNLOADS","tiedostoa");
define_once("_VOTE","Äänestä");
define_once("_VOTES","Äänet");
define_once("_MVIEWADMIN","Näytetään: Vain ylläpitäjille");
define_once("_MVIEWUSERS","Näytetään: Vain rekisteröityneille");
define_once("_MVIEWANON","Näytetään: Vain Anonyymeille");
define_once("_MVIEWALL","Näytetään: Kaikille");
define_once("_EXPIRELESSHOUR","Voimassa: Alle tunti");
define_once("_EXPIREIN","voimassa");
define_once("_HTTPREFERERS","Linkitykset Sivuillemme");
define_once("_UNLIMITED","rajoittamaton");
define_once("_HOURS","Tuntia");
define_once("_RSSPROBLEM","Otsikoiden kanssa on ongelmaa tällä hetkellä");
define_once("_SELECTLANGUAGE","Valitse kieli");
define_once("_SELECTGUILANG","Valitse näkymän kieli:");
...
define_once("_THISISAUTOMATED","This is an automated email to let you know that your banner advertising in our site has been finished right now.");
define_once("_THERESULTS","The results of your campaign is as follow:");
...
define_once("_HOPEYOULIKED","Hope you liked our service. We'll look to have you as advertising customer again soon.");
