...
if(is_user() && $userinfo['user_avatar']):
  switch( $userinfo['nuke_user_avatar_type']):
		# user_allowavatar = 1
...
if($_COOKIE["remote_screen_width"] > 1366):
if (!is_user()) 
{
   ...
   echo '</div>';
    ...
    echo '         <li><strong><a href="admin.php?op=blogtopicsmanager" class="btn btn-primary dropbtn" role="button">Create New Blog Topic</a></strong></li>';
...
if (is_user()) 
{
   ...
   ################################################################################################################################################################ 
    ...
    echo '         <li><strong><a href="admin.php?op=blogtopicsmanager" class="btn btn-danger adropbtn-admin" role="button">Create New Blog Topic</a></strong></li>';      #
