...
<!-- BEGIN topics_where_only_this_nuke_user_posts -->
  	<tr>
	  <td class="catHead" height="28" align="center" colspan="2"><span class="cattitle">{topics_where_only_this_nuke_user_posts.L_DELETED_TOPICS2}</span></td>
	</tr>

	<tr>
	  <td align="center" class="row2" valign="middle" height="28"><span class="genmed">{topics_where_only_this_nuke_user_posts.L_DELETED_TOPICS2}:</span></td>
	  <td align="center" class="row2" valign="middle" height="28"><span class="genmed"><strong>{topics_where_only_this_nuke_user_posts.LIST_DELETED_TOPICS2}</strong><br></span></td>
	</tr>

 	<tr>
	  	<td align="center" class="row2" valign="middle" height="28"><span class="genmed">{topics_where_only_this_nuke_user_posts.L_TOTAL}: </span></td>
	  	<td align="center" class="row2" valign="middle" height="28"><span class="genmed"><strong>{topics_where_only_this_nuke_user_posts.TOTAL_DELETED_TOPICS2}</strong></span></td>
	</tr>
	
 	<tr>
	  	<td align="center" class="row2" valign="middle" height="28"><span class="genmed">{topics_where_only_this_nuke_user_posts.L_DELETED_POSTS_IN_U_TOPICS2}:</span></td>
	  	<td align="center" class="row2" valign="middle" height="28"><span class="genmed">{topics_where_only_this_nuke_user_posts.LIST_DELETED_POSTS_IN_U_TOPICS2}</span></td>
	</tr>
	
	 <tr>
	  	<td align="center" class="row2" valign="middle" height="28"><span class="genmed">{topics_where_only_this_nuke_user_posts.L_TOTAL}:</span></td>
	  	<td align="center" class="row2" valign="middle" height="28"><span class="genmed"><strong>{topics_where_only_this_nuke_user_posts.TOTAL_DELETED_POSTS_IN_U_TOPICS2}</strong></span></td>
	</tr>
<!-- END topics_where_only_this_nuke_user_posts -->
...
<!-- BEGIN all_other_nuke_user_posts_in_other_topics -->
  	<tr>
	  <td class="catHead" height="28" align="center" colspan="2"><span class="cattitle">{all_other_nuke_user_posts_in_other_topics.L_OTHER_POSTS}</span></td>
	</tr>
	<tr>
	  	<td align="center" class="row2" valign="middle" height="28"><span class="genmed">{all_other_nuke_user_posts_in_other_topics.L_OTHER_POSTS}:</span></td>
	  	<td align="center" class="row2" valign="middle" height="28"><span class="genmed">{all_other_nuke_user_posts_in_other_topics.LIST_DELETED_OTHER_POSTS}</span></td>
	</tr>

<br>
{all_other_nuke_user_posts_in_other_topics.L_TOTAL}: <strong>{all_other_nuke_user_posts_in_other_topics.NUM_OF_OTHER_POSTS}</strong></p>
<!-- END all_other_nuke_user_posts_in_other_topics -->
