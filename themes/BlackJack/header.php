...
$scrollmsg .= 'The current Beta release of PHP-Nuke is v'.NUKE_VERSION.' and we are running on PHP v'.PHPVERS.' ::: ';
...
echo '<a href="https://github.com/ernestbuffington/phpnuke.coders.exchange" target="_blank"><img class="hover_effect" width="64" src="images/brands/png/github-active.png" /></a>&nbsp;&nbsp;'.PHP_EOL;
...
echo '<tr><td style="height: 23px !important; width: 33.3%;"><div class="above_marquee_one" align="center">PHP-Nuke v'.NUKE_VERSION.' / PHP v'.PHPVERS.'</div></td>'.PHP_EOL;
echo '<td style="height: 23px !important; width: 33.3%;"><div align="center"></div></td>'.PHP_EOL;
echo '<td style="height: 23px !important; width: 33.3%;"><div class="above_marquee_two" align="center">Sponsor Tron for PHP-Nuke</div></td></tr>'.PHP_EOL;
