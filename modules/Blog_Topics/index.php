...
{
    $output = "<div align=\"center\"><span class=\"title\"><strong>"._ACTIVETOPICS_BLOG."</strong></span><br />\n";
    $output .= "<span class=\"content\">"._CLICK2LIST_BLOG."</span><br /><br />\n";
    ...
    while ($row = $db->sql_fetchrow($result)) 
	{
		...
		src="'.img('topic-blogs-16.png','Blog_Topics').'"> <strong>'._TOTBLOGS.' </strong>( <font color="'.$digits_color.'"><strong>'.$row['stories'].'</strong></font> )<br />';
        
		$output .= '<img class="icons" align="absmiddle" width="16" 
		src="'.img('reads-icon-16.png','Blog_Topics').'"> <strong>'._TOTREADS_BLOGS.' </strong>( <font color="'.$digits_color.'"><strong>'.($row['readcount'] ?? 0).'</strong></font> )</span>';
