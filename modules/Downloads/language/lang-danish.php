...
define_once("_ADDTHISFILE","Tilføj denne fil");
...
define_once("_ADDDOWNLOAD","Foreslå nyt download");
...
define_once("_ADDADOWNLOAD","Foreslå nyt download");
define_once("_DSUBMITONCE","Insend kun et forslag én gang.");
define_once("_DPOSTPENDING","Alle forslag skal godkendes før de aktiveres.");
...
define_once("_DOWNLOADSNOTUSER2","Som bruger kan du foreslå nye downloads.");
define_once("_DOWNLOADSNOTUSER3","At blive oprettet som bruger er hurtigt og nemt.");
define_once("_DOWNLOADSNOTUSER4","Hvorfor kræver vi registrering for at opnå adgang til dele af vores site?");
define_once("_DOWNLOADSNOTUSER5","Fordi vi så kan tilbyde dig det bedst mulige kvalitetsindhold,");
define_once("_DOWNLOADSNOTUSER6","alt indhold bliver individuelt gennemgået og godkendt af vores team.");
define_once("_DOWNLOADSNOTUSER7","Vi ønsker udelukkende at kunne tilbyde dig kvalitetsindhold.");
...
define_once("_DOWNLOADNOTITLE","FEJL: Du skal indtaste et NAVN på din internetadresse!");
...
define_once("_DDATE1","Dato (Gamle downloads først)");
define_once("_DDATE2","Dato (Nye downloads først)");
define_once("_DOWNLOADPROFILE","Downloadprofil");
define_once("_DOWNLOADRATINGDET","Oplysninger om rating af download");
define_once("_EDITTHISDOWNLOAD","Redigér denne download");
define_once("_DOWNLOADRATING","Downloadratings");
define_once("_DOWNLOADVOTE","Stem!");
define_once("_REQUESTDOWNLOADMOD","Foreslå ændring af downloads");
define_once("_DOWNLOADID","Download ID");
define_once("_DLETSDECIDE","Tilbagemeldinger fra brugere som dig selv, hjælper andre brugere til at beslutte hvad de skal downloade.");
...
define_once("_SECURITYBROKEN","Af sikkerhedsmæssige årsager er dit brugernavn og IP-adresse midlertidigt gemt.");
