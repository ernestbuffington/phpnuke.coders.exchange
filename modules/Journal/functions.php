...
if ( !defined('MODULE_FILE') )
{
    ...
    function startjournal($sitename, $user) {
        ...
        if (is_user()) {
            $j_user1 = "<center>[ <a href=\"modules.php?name=Journal\">"._JOURNALDIR."</a> | <a href=\"modules.php?name=Journal&file=edit\">"._YOURJOURNAL."</a> ]</center>";
            $j_user2 = "";
        } else {
            $j_user1 = "<center>[ <a href=\"modules.php?name=Journal\">"._JOURNALDIR."</a> | <a href=\"modules.php?name=Your_Account&op=new_user\">"._CREATEACCOUNT."</a> ]</center>";
        ...
        OpenTable();
        echo "<center><img src=modules/Journal/images/bgimage.gif><br><font class=title><b>"._USERSJOURNAL."</b></font></center>";
        echo "$j_user1";
        echo "$j_user2";
        CloseTable();
    }
