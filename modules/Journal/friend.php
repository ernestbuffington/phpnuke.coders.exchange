...
if ( !defined('MODULE_FILE') )
{
    ...
    if (is_user()) {
        ...
        if ($send == 1) {
            ...
            $message = ""._HELLO." $fname:\n\n"._YOURFRIEND." $yname "._CONSIDERED."\n\n\n$jtitle\n"._URL.": $nukeurl/modules.php?name=Journal&file=display&jid=$jid\n\n\n"._AREMORE."\n\n---\n$sitename\n$nukeurl";
        ...
        if ($sent == 1) {
            ...
            OpenTable();
            echo "<center>"._FSENT."<br><br>[ <a href=\"modules.php?name=Journal&file=display&jid=$jid\">"._RETURNJOURNAL2."</a> ]</center>";
            CloseTable();
        ...
        echo "<table align=center border=0><tr><td>" ."<center><b>$jtitle</b><br>"._YOUSENDJOURNAL."</center><br><br>" ."<form 
		action=\"modules.php?name=Journal&file=friend\" method=\"post\">" ."<input type=\"hidden\" name=\"send\" value=\"1\">" ."<input type=\"hidden\" name=\"jid\" value=\"$jid\">";
