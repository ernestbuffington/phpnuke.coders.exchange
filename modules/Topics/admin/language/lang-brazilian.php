...
define_once("_NO","Nгo");
define_once("_TOPICSMANAGER","Gerenciador de Tуpicos");
define_once("_DELETETOPIC","Apagar Tуpico");
define_once("_TOPICDELSURE","Vocк tem certeza de que quer apagar este Tуpico?");
define_once("_TOPICDELSURE1","Esta aзгo irб apagar TODAS as notнcias e seus comentбrios!!!");
