...
//-------------------------------------------------------------------------
if(file_exists(NUKE_MODULES_DIR.$module_name.'/language/lang-'.$userinfo['nuke_user_lang'].'.php'))
	include_once(NUKE_MODULES_DIR.$module_name.'/language/lang-'.$userinfo['nuke_user_lang'].'.php');
else
