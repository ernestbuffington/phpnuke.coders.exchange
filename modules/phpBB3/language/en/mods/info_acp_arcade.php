...
$lang = array_merge($lang, array(
	'PHPBB3_ACL_TYPE_C_'										=> 'Category permissions',
	'PHPBB3_ACL_TYPE_LOCAL_C_'									=> 'Category permissions',
	...
	'CAT_PASSWORD_PHPBB3_CONFIRM_EXPLAIN'						=> 'Only needs to be set if a category password is entered.',
	...
	'LOCKED'											=> 'Locked',
	'LOG_PHPBB3_ACL_ADD_CATEGORY_LOCAL_C_'						=> '<strong>Added or edited arcade category permissions</strong> from %1$s<br />» %2$s',
	'LOG_PHPBB3_ACL_ADD_GROUP_LOCAL_C_'						=> '<strong>Added or edited groups’ arcade category access</strong> from %1$s<br />» %2$s',
	'LOG_PHPBB3_ACL_ADD_USER_LOCAL_C_'							=> '<strong>Added or edited users’ arcade category access</strong> from %1$s<br />» %2$s',
	'LOG_PHPBB3_ACL_ARCADE_RESTORE_PERMISSIONS'				=> '<strong>Own arcade permissions restored after using permissions from</strong><br />» %s',
	'LOG_PHPBB3_ACL_ARCADE_TRANSFER_PERMISSIONS'				=> '<strong>Arcade permissions transferred from</strong><br />» %s',
	'LOG_PHPBB3_ACL_DEL_CATEGORY_LOCAL_C_'						=> '<strong>Removed User/Group arcade category permissions</strong> from %1$s<br />» %2$s',
