...
$lang = array_merge($lang, array(
	...
	'PHPBB3_PHPBB3_ACL_NEVER'				=> 'Never',
	'PHPBB3_ACL_SET'				=> 'Setting permissions',
	'PHPBB3_ACL_SET_EXPLAIN'		=> 'Permissions are based on a simple <samp>YES</samp>/<samp>NO</samp> system. Setting an option to <samp>NEVER</samp> for a user or usergroup overrides any other value assigned to it. If you do not wish to assign a value for an option for this user or group select <samp>NO</samp>. If values are assigned for this option elsewhere they will be used in preference, else <samp>NEVER</samp> is assumed. All objects marked (with the checkbox in front of them) will copy the permission set you defined.',
	'PHPBB3_ACL_SETTING'			=> 'Setting',

	'PHPBB3_ACL_TYPE_A_'			=> 'Administrative permissions',
	'PHPBB3_ACL_TYPE_F_'			=> 'Forum permissions',
	'PHPBB3_ACL_TYPE_M_'			=> 'Moderative permissions',
	'PHPBB3_ACL_TYPE_U_'			=> 'User permissions',

	'PHPBB3_ACL_TYPE_GLOBAL_A_'	=> 'Administrative permissions',
	'PHPBB3_ACL_TYPE_GLOBAL_U_'	=> 'User permissions',
	'PHPBB3_ACL_TYPE_GLOBAL_M_'	=> 'Global Moderator permissions',
	'PHPBB3_ACL_TYPE_LOCAL_M_'		=> 'Forum Moderator permissions',
	'PHPBB3_ACL_TYPE_LOCAL_F_'		=> 'Forum permissions',
	
	'PHPBB3_PHPBB3_ACL_NO'				=> 'No',
	'PHPBB3_ACL_VIEW'				=> 'Viewing permissions',
	'PHPBB3_ACL_VIEW_EXPLAIN'		=> 'Here you can see the effective permissions the user/group is having. A red square indicates that the user/group does not have the permission, a green square indicates that the user/group does have the permission.',
	'PHPBB3_PHPBB3_ACL_YES'				=> 'Yes',
	...
	'TRACE_PHPBB3_USER_FOUNDER'					=> 'The user has the founder type set, therefore admin permissions are set to <samp>YES</samp> by default.',
