...
$lang = array_merge($lang, array(
	...
	'PHPBB3_CONFIRM_IMAGESET_REFRESH'		=> 'Are you sure you wish to refresh all imageset data? The settings from the imageset configuration file will overwrite all modifications to the imageset which have been carried out with the imageset editor.',
	'PHPBB3_CONFIRM_TEMPLATE_CLEAR_CACHE'	=> 'Are you sure you wish to clear all cached versions of your template files?',
	'PHPBB3_CONFIRM_TEMPLATE_REFRESH'		=> 'Are you sure you wish to refresh all template data in the database with the contents of the template files on the filesystem? This will overwrite all modifications which have been carried out with the template editor while the template was stored in the database.',
	'PHPBB3_CONFIRM_THEME_REFRESH'			=> 'Are you sure you wish to refresh the theme data stored in the database with the contents of the theme on the filesystem? This will overwrite all modifications which have been carried out with the theme editor while the theme was stored in the database.',
	'COPYRIGHT'						=> 'Copyright',
	...
	'IMG_PHPBB3_FORUM_LINK'			=> 'Forum link',
	...
	'UNSET'					=> 'Undefined',
	'IMG_CAT_FFAVORITES'			=> 'Forum Favorites icons',
	'IMG_ICON_FFAVORITES_ADD'		=> 'Forum Favorite Add button',
	'IMG_ICON_FFAVORITES_SEARCH'	=> 'Forum Favorite View Users button',
