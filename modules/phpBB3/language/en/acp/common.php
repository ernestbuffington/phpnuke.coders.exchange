...
$lang = array_merge($lang, array(
	...
	'ACP_PHPBB3_ATTACHMENT_SETTINGS'	=> 'Attachment settings',
	...
	'ACP_FAVORITES_CATEGORIES_CONFIG'		=>	'Edit Favorites categories',
...
// Log Entries
$lang = array_merge($lang, array(
	'LOG_PHPBB3_ACL_ADD_USER_GLOBAL_U_'		=> '<strong>Added or edited users’ user permissions</strong><br />» %s',
	'LOG_PHPBB3_ACL_ADD_GROUP_GLOBAL_U_'		=> '<strong>Added or edited groups’ user permissions</strong><br />» %s',
	'LOG_PHPBB3_ACL_ADD_USER_GLOBAL_M_'		=> '<strong>Added or edited users’ global moderator permissions</strong><br />» %s',
	'LOG_PHPBB3_ACL_ADD_GROUP_GLOBAL_M_'		=> '<strong>Added or edited groups’ global moderator permissions</strong><br />» %s',
	'LOG_PHPBB3_ACL_ADD_USER_GLOBAL_A_'		=> '<strong>Added or edited users’ administrator permissions</strong><br />» %s',
	'LOG_PHPBB3_ACL_ADD_GROUP_GLOBAL_A_'		=> '<strong>Added or edited groups’ administrator permissions</strong><br />» %s',

	'LOG_PHPBB3_ACL_ADD_ADMIN_GLOBAL_A_'		=> '<strong>Added or edited Administrators</strong><br />» %s',
	'LOG_PHPBB3_ACL_ADD_MOD_GLOBAL_M_'			=> '<strong>Added or edited Global Moderators</strong><br />» %s',

	'LOG_PHPBB3_ACL_ADD_USER_LOCAL_F_'			=> '<strong>Added or edited users’ forum access</strong> from %1$s<br />» %2$s',
	'LOG_PHPBB3_ACL_ADD_USER_LOCAL_M_'			=> '<strong>Added or edited users’ forum moderator access</strong> from %1$s<br />» %2$s',
	'LOG_PHPBB3_ACL_ADD_GROUP_LOCAL_F_'		=> '<strong>Added or edited groups’ forum access</strong> from %1$s<br />» %2$s',
	'LOG_PHPBB3_ACL_ADD_GROUP_LOCAL_M_'		=> '<strong>Added or edited groups’ forum moderator access</strong> from %1$s<br />» %2$s',

	'LOG_PHPBB3_ACL_ADD_MOD_LOCAL_M_'			=> '<strong>Added or edited Moderators</strong> from %1$s<br />» %2$s',
	'LOG_PHPBB3_ACL_ADD_FORUM_LOCAL_F_'		=> '<strong>Added or edited forum permissions</strong> from %1$s<br />» %2$s',

	'LOG_PHPBB3_ACL_DEL_ADMIN_GLOBAL_A_'		=> '<strong>Removed Administrators</strong><br />» %s',
	'LOG_PHPBB3_ACL_DEL_MOD_GLOBAL_M_'			=> '<strong>Removed Global Moderators</strong><br />» %s',
	'LOG_PHPBB3_ACL_DEL_MOD_LOCAL_M_'			=> '<strong>Removed Moderators</strong> from %1$s<br />» %2$s',
	'LOG_PHPBB3_ACL_DEL_FORUM_LOCAL_F_'		=> '<strong>Removed User/Group forum permissions</strong> from %1$s<br />» %2$s',

	'LOG_PHPBB3_ACL_TRANSFER_PERMISSIONS'		=> '<strong>Permissions transferred from</strong><br />» %s',
	'LOG_PHPBB3_ACL_RESTORE_PERMISSIONS'		=> '<strong>Own permissions restored after using permissions from</strong><br />» %s',

	'PHPBB3_LOG_ADMIN_AUTH_FAIL'		=> '<strong>Failed administration login attempt</strong>',
	'PHPBB3_LOG_ADMIN_AUTH_SUCCESS'	=> '<strong>Successful administration login</strong>',
    ...
    'LOG_FAVORITES_CAT_DELETE'	=> '<strong>Category deleted</strong><br />» %s',
	...
	'PHPBB3_LOG_MODS_ADDED'		=> '<strong>Added new leaders to usergroup</strong> %1$s<br />» %2$s',
	'PHPBB3_LOG_USERS_APPROVED'	=> '<strong>Users approved in usergroup</strong> %1$s<br />» %2$s',
	'PHPBB3_LOG_USERS_ADDED'		=> '<strong>Added new members to usergroup</strong> %1$s<br />» %2$s',
	...
	'LOG_PHPBB3_INACTIVE_REMIND'	=> '<strong>Sent reminder e-mails to inactive users</strong><br />» %s',
	...
	'PHPBB3_LOG_MODULE_DISABLE'	=> '<strong>Module disabled</strong><br />» %s',
	'PHPBB3_LOG_MODULE_ENABLE'		=> '<strong>Module enabled</strong><br />» %s',
	'PHPBB3_LOG_MODULE_MOVE_DOWN'	=> '<strong>Module moved down</strong><br />» %1$s below %2$s',
	'PHPBB3_LOG_MODULE_MOVE_UP'	=> '<strong>Module moved up</strong><br />» %1$s above %2$s',
	'PHPBB3_LOG_MODULE_REMOVED'	=> '<strong>Module removed</strong><br />» %s',
	'PHPBB3_LOG_MODULE_ADD'		=> '<strong>Module added</strong><br />» %s',
	'PHPBB3_LOG_MODULE_EDIT'		=> '<strong>Module edited</strong><br />» %s',
	...
	'LOG_REFERER_INVALID'		=> '<strong>Referer validation failed</strong><br />Â»Referer was â€œ<em>%1$s</em>â€. The request was rejected and the session killed.',
	...
	'LOG_PHPBB3_USER_INACTIVE'		=> '<strong>User deactivated</strong><br />» %s',
	...
	'LOG_PHPBB3_USER_INACTIVE_USER'	=> '<strong>User account de-activated</strong>',
