...
//-- mod: Prime Warnings ----------------------------------------------------//
		if ($member['user_warnings'])
		{
			...
			prime_warnings($member['user_warnings'], 'warnings');
		}
//-- end: Prime Warnings ----------------------------------------------------//
...
function show_profile($data)
{
    ...
    $flag_country = $flag_code = $flag_img = $flag_img_src = '';
	get_user_flag($data['user_flag'], $flag_country, $flag_code, $flag_img, $flag_img_src);
	$rank_title = $rank_img = $rank_img_src = '';
