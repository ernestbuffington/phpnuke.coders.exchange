...
$first_post_text = ''; // Meta Keywords MOD 
...
//-- fin mod : Genders --------------------------------------------------------
		...
		'S_USERID_VIEWTOPIC'	=> ($config['load_userid_viewtopic']) ? true : false,
        // end
...
//-- mod: Prime Warnings ----------------------------------------------------//
	if ($user_cache[$poster_id]['warnings'])
	{
		...
		prime_warnings($user_cache[$poster_id]['warnings'], 'postrow.warnings');
	}
//-- end: Prime Warnings ----------------------------------------------------//
...
//-- mod: Prime Quick Reply -------------------------------------------------//
prime_quick_reply($topic_id, $forum_id, $topic_data, $last_post);
//-- end: Prime Quick Reply -------------------------------------------------//
page_footer();
