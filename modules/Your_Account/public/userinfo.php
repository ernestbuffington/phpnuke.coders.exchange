...
if ($num > 0): 
    ...
    if ($usrinfo[user_level] > 0): 
        ...
        if($num == 1): 
		    ...
		    # AVATAR TYPES START
			if ($usrinfo['nuke_user_avatar_type'] == 1):     # Type 1
            $user_avatar = $board_config['avatar_path']."/".$usrinfo['user_avatar'];
            
			elseif($usrinfo['nuke_user_avatar_type'] == 2):  # Type 2
			...
			$usrinfo['nuke_user_sig'] = nl2br($usrinfo['nuke_user_sig']);
            ...
            echo "<tr>\n<td width='30%' bgcolor='$bgcolor1'>"._REGDATE."</td>\n<td width='70%' bgcolor='$bgcolor1'><strong>$usrinfo[nuke_user_regdate]</strong></td>\n</tr>\n";
            ...
            echo "<tr>\n<td width='30%' bgcolor='$bgcolor1'>"._SIGNATURE."</td>\n<td width='70%' bgcolor='$bgcolor1'><strong>$usrinfo[nuke_user_sig]</strong></td>\n</tr>\n";
