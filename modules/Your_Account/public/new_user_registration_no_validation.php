...
function tz_select($default, $select_name = 'timezone')
{
            ...
            switch($code_name):
                ...
                case "signature":
                    echo '<tr><td style="background-color: '.$bgcolor2.'; border: 0.1px solid '.$bgcolor1.';"><div class="textbold">&nbsp;&nbsp;'._SIGNATURE.':</div><span 
					      ...
					      style="background-color: '.$bgcolor2.'; border: 0.1px solid '.$bgcolor1.';"><textarea cols="50" rows="5" name="nuke_user_sig"></textarea><br /><span 
	...
	echo '<tr><td style="background-color: '.$bgcolor2.'; border: 0.1px solid '.$bgcolor1.';"><div class="textbold">&nbsp;&nbsp;'._FORUMSDATE.':</div></td><td 
	      style="background-color: '.$bgcolor2.'; border: 0.1px solid '.$bgcolor1.';"><input type="text" name="nuke_user_dateformat" 
