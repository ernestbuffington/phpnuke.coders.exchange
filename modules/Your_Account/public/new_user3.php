...
function tz_select($default, $select_name = 'timezone')
{
        ...
        $tz_select = '<select name="nuke_user_timezone">';
    ...
    while ( list($code_name, $info) = each($xd_meta) )
    {
            ...
            elseif ($info['display_register'] == XD_DISPLAY_ROOT)
            {
                switch ($code_name) {
                    ...
                    break;
                    case "signature":
                        echo "<tr><td bgcolor='$bgcolor2'><div class=\"textbold\">"._SIGNATURE.":</div>"._OPTIONAL."<br />"._NOHTML."</td><td bgcolor='$bgcolor1'><textarea cols='50' rows='5' name='nuke_user_sig'></textarea><br />"._255CHARMAX."</td></tr>\n";
                    break;
                }
            }
    }
 ...
 ******************************************************/
    ...
    echo "</td></tr>\n";
    echo "<tr><td bgcolor='$bgcolor2'><div class=\"textbold\">"._FORUMSDATE.":</div>"._FORUMSDATEMSG."</td><td bgcolor='$bgcolor1'><input type='text' name='nuke_user_dateformat' value='D M d, Y g:i a' size='15' maxlength='14'></td></tr>\n";
