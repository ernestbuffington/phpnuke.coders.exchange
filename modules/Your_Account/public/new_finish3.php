 ...
 ******************************************************/
    ...
    $db->sql_query("UPDATE ".$user_prefix."_users SET user_avatar='gallery/blank.png', nuke_user_avatar_type='3', nuke_user_lang='$language', user_lastvisit='$lv', umode='nested' WHERE user_id='$new_uid'");
    ...
    $db->sql_query("UPDATE ".$user_prefix."_users SET username='$ya_username', 
							   ...
							   user_allow_viewonline='$user_allow_viewonline', 
										   ...
										   nuke_user_dateformat='$nuke_user_dateformat', 
										                 nuke_user_sig='$nuke_user_sig', 
														           bio='$bio', 
											    user_password='$new_password', 
												  nuke_user_regdate='$nuke_user_regdate' WHERE user_id='$new_uid'");
