...
//      echo "<tr><td><strong>"._YA_PASSWORD.":</strong> $user_password<br /></td></tr>";
        ...
        echo "<input type='hidden' name='nuke_user_timezone' value=\"$nuke_user_timezone\">\n";
        echo "<input type='hidden' name='nuke_user_dateformat' value=\"$nuke_user_dateformat\">\n";
        echo "<input type='hidden' name='nuke_user_sig' value=\"$nuke_user_sig\">\n";
