...
if (!defined('CNBYA')) {
    ...
    if ($code == $pass) {
        ...
        $db->sql_query("UPDATE ".$user_prefix."_users SET name='"._MEMDEL."', user_email='', user_password='', user_website='', nuke_user_sig='', nuke_user_regdate='Non 0, 0000', user_level='-1', user_active='0', user_allow_pm='0' WHERE user_id='$uid'");
        global $cookie;
        $r_uid = $cookie[0];
        $r_uname = $cookie[1];
        setcookie("user");
