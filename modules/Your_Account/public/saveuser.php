 ...
 ******************************************************/
            ...
            if ( ($ya_config['emailvalidate'] == '0') OR ($tuemail == $user_email) ) {
                ...
                $db->sql_query("UPDATE ".$user_prefix."_users SET name='$realname', femail='$femail', user_website='$user_website', user_password='$user_password', bio='$bio', user_icq='$user_icq', user_occ='$user_occ', user_from='$user_from', user_interests='$user_interests', nuke_user_sig='$nuke_user_sig', user_aim='$user_aim', user_yim='$user_yim', user_msnm='$user_msnm', newsletter='$newsletter', user_viewemail='$user_viewemail', user_allow_viewonline='$user_allow_viewonline', user_notify='$user_notify', nuke_user_notify_pm='$nuke_user_notify_pm', user_popup_pm='$user_popup_pm', user_attachsig='$user_attachsig', user_allowbbcode='$user_allowbbcode', user_allowhtml='$user_allowhtml', user_allowsmile='$user_allowsmile', nuke_user_timezone='$nuke_user_timezone', nuke_user_dateformat='$nuke_user_dateformat' WHERE user_id='$user_id'");
                $datekey = date("F Y");
        ...
        if ( ($ya_config['emailvalidate'] == '0') OR ($tuemail == $user_email) ) {
            $q = "UPDATE ".$user_prefix."_users SET name='$realname', user_email='$user_email', femail='$femail', user_website='$user_website', bio='$bio', user_icq='$user_icq', user_occ='$user_occ', user_from='$user_from', user_interests='$user_interests', nuke_user_sig='$nuke_user_sig', user_aim='$user_aim', user_yim='$user_yim', user_msnm='$user_msnm', newsletter='$newsletter', user_viewemail='$user_viewemail', user_allow_viewonline='$user_allow_viewonline', user_notify='$user_notify', nuke_user_notify_pm='$nuke_user_notify_pm', user_popup_pm='$user_popup_pm', user_attachsig='$user_attachsig', user_allowbbcode='$user_allowbbcode', user_allowhtml='$user_allowhtml', user_allowsmile='$user_allowsmile', nuke_user_timezone='$nuke_user_timezone', nuke_user_dateformat='$nuke_user_dateformat' WHERE user_id='$user_id'";
                $db->sql_query($q);
            } else {

                $db->sql_query("UPDATE ".$user_prefix."_users SET name='$realname', femail='$femail', user_website='$user_website', bio='$bio', user_icq='$user_icq', user_occ='$user_occ', user_from='$user_from', user_interests='$user_interests', nuke_user_sig='$nuke_user_sig', user_aim='$user_aim', user_yim='$user_yim', user_msnm='$user_msnm', newsletter='$newsletter', user_viewemail='$user_viewemail', user_allow_viewonline='$user_allow_viewonline', user_notify='$user_notify', nuke_user_notify_pm='$nuke_user_notify_pm', user_popup_pm='$user_popup_pm', user_attachsig='$user_attachsig', user_allowbbcode='$user_allowbbcode', user_allowhtml='$user_allowhtml', user_allowsmile='$user_allowsmile', nuke_user_timezone='$nuke_user_timezone', nuke_user_dateformat='$nuke_user_dateformat' WHERE user_id='$user_id'");
                $datekey = date("F Y");
                $check_num = substr(md5(hexdec($datekey) * hexdec($cookie[2]) * hexdec($sitekey) * hexdec($user_email) * hexdec($tuemail)), 2, 10);
