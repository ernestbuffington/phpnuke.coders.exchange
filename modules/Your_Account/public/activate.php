...
if (!defined('CNBYA')) {
    ...
    $ya_time = $row_act['time'];
        ...
        echo "<tr><td bgcolor='$bgcolor2'>"._FORUMSTIME."</td><td bgcolor='$bgcolor1'><select name='nuke_user_timezone'>";
        $utz = date("Z");
        $utz = round($utz/3600);
        for ($i=-12; $i<13; $i++) {
            if ($i == 0) {
        ...
        echo "<input type=\"text\" name=\"nuke_user_dateformat\" value=\"D M d, Y g:i a\" size='15' maxlength='14'></td></tr>\n";
        echo "<tr><td bgcolor='$bgcolor2'>"._SIGNATURE.":<br />"._OPTIONAL."<br />"._NOHTML."</td>";
        echo "<td bgcolor='$bgcolor1'><textarea wrap=\"virtual\" cols=\"50\" rows=\"5\" name=\"nuke_user_sig\">$userinfo[nuke_user_sig]</textarea><br />"._255CHARMAX."</td></tr>\n";
