...
if (!defined('CNBYA')) {
    ...
    if ($db->sql_numrows($result) == 1) {
        ...
        $nuke_user_regdate = $row['nuke_user_regdate'];
        ...
        $db->sql_query("INSERT INTO ".$user_prefix."_users (user_id, user_avatar, nuke_user_avatar_type, nuke_user_lang, user_lastvisit, umode) VALUES ($new_uid, 'gallery/blank.png', '3', '$language', '$lv', 'nested')");
        $db->sql_query("UPDATE ".$user_prefix."_users SET username='$username', name='$realname', user_email='$user_email', femail='$femail', user_website='$user_website', user_from='$user_from', user_occ='$user_occ', user_interests='$user_interests', newsletter='$newsletter', user_viewemail='$user_viewemail', user_allow_viewonline='$user_allow_viewonline', nuke_user_timezone='$nuke_user_timezone', nuke_user_dateformat='$nuke_user_dateformat', nuke_user_sig='$nuke_user_sig', bio='$bio', user_password='$user_password', nuke_user_regdate='$nuke_user_regdate' WHERE user_id='$new_uid'");
