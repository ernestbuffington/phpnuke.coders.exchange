...
// Group Memberships
$result = $db->sql_query("SELECT ug.nuke_group_id, g.group_name FROM ".$prefix."_bbuser_group ug INNER JOIN ".$prefix."_bbgroups g ON (g.nuke_group_id = ug.nuke_group_id AND g.group_single_user = 0) WHERE ug.user_pending = 0 AND ug.user_id = ".$usrinfo['user_id']);
