...
if(is_mod_admin($module_name)) {
    ...
    echo "<tr><td bgcolor='$bgcolor2'>"._FAKEEMAIL.":</td><td><strong>".$chnginfo['femail']."</strong></td></tr>\n";
        ...
        $chnginfo['nuke_user_sig'] = str_replace("\r\n", "<br />", $chnginfo['nuke_user_sig']);
        echo "<tr><td bgcolor='$bgcolor2' valign='top'>"._SIGNATURE.":</td><td><strong><xmp>".$chnginfo['nuke_user_sig']."</xmp></strong></td></tr>\n";
