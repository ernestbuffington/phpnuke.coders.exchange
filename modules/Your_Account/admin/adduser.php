...
-=[Mod]=-
	  Update / Fix HTML                           v5.0.0       04/06/2023
 ************************************************************************/
...
if(is_mod_admin($module_name)) {
    ...
    echo "<tr><td bgcolor='$bgcolor2' valign='top'>"._SIGNATURE.":</td><td bgcolor='$bgcolor1'><textarea name='add_nuke_user_sig' rows='6' cols='45'></textarea></td></tr>\n";
