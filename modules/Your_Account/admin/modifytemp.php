...
if(is_mod_admin($module_name)) {
    ...
    OpenTable();
    echo "<div align=\"center\"><table border='0'><form action='modules.php?name=$module_name&amp;file=admin' method='post'>\n";
    ...
    echo "<tr><td bgcolor='$bgcolor2'>"._REGDATE.":</td><td><input type='text' value='$chnginfo[nuke_user_regdate]' size='40' disabled=disabled style='color=#000000;background-color: #FFFFFF'></td></tr>\n";
    ...
    OpenTable();
    echo "<div align=\"center\"><strong>"._USERNOEXIST."</strong></div>\n";
    CloseTable();
  }
