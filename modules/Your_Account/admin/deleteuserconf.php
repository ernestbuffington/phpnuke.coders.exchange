...
if(is_mod_admin($module_name)) {
    ...
    $db->sql_query("UPDATE ".$user_prefix."_users SET name='"._MEMDEL."', username='"._NAMEDEL."', user_password='', user_website='', nuke_user_sig='', user_level='-1', user_active='0', user_allow_pm='0', points='0' WHERE user_id='$del_uid'");
