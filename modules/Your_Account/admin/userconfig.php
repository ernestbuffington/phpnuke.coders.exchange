...
if(is_mod_admin($module_name)) {
    ...
    OpenTable();
    echo "<form action='modules.php?name=$module_name&amp;file=admin' method='post'><div align=\"center\"><table border='0' cellpadding='2' cellspacing='2'>\n";
    ...
    echo "</table></div><input type='hidden' name='op' value='UsersConfigSave'></form>";
    CloseTable();
