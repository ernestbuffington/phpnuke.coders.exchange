...
define_once("_FNOTIFY","Notify me by email when there is a new post.(Only for registerd users)");
...
define_once("_NOTIFM1","You have recieved this email because someone has posted a reply to your message you posted on $sitename, and you chose");
define_once("_NOTIFM2"," to be informed by email when this happened.\r\n\r\nYou can see the discussion here: ");
...
define_once("_FNOTMAIL","Notify Email");
...
define_once("_FORUMMENU","Forum Administration Menù");
