...
function smtpmail($mail_to, $subject, $message, $headers = '')
{
        ...
        if( !empty($board_config['smtp_username']) && !empty($board_config['smtp_password']) )
        {
                ...
                fputs($socket, base64_encode((string) $board_config['smtp_username']) . "\r\n");
                server_parse($socket, "334", __LINE__);

                fputs($socket, base64_encode((string) $board_config['smtp_password']) . "\r\n");
	...
	$mail_to = (trim((string) $mail_to) == '') ? 'Undisclosed-recipients:;' : trim((string) $mail_to);
