...
<table cellpadding="4" cellspacing="1" border="0" class="forumline" style="width: 99%;">
  ...
  <tr>
    ...
    <td class="row2" style="height: 35px; width: 50%;"><input type="radio" name="override_nuke_user_style" value="1" {OVERRIDE_STYLE_YES} /> {L_YES} <input type="radio" name="override_nuke_user_style" value="0" {OVERRIDE_STYLE_NO} /> {L_NO}</td>
  </tr>
  <!-- Quick Search -->
  <tr>
    <td class="row1" style="height: 35px; width: 50%;">
