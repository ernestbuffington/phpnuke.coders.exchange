        ...
        <tr>
          ...
          <td class="row1" nowrap="nowrap">
            <select name="sort" class="post">
              ...
              <option value="nuke_user_regdate"{SELECTED_JOINED}>{L_SORT_JOINED}</option>
              ...
              <option value="nuke_user_posts"{SELECTED_POSTS}>{L_SORT_POSTS}</option>
              <option value="nuke_user_rank"{SELECTED_RANK}>{L_SORT_RANK}</option>
