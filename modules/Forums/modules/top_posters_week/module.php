 ...
 ******************************************************/
$sql = "SELECT u.user_id, u.user_color_gc, u.username, count(u.user_id) as nuke_user_posts
...
{
    $total_posts_thisweek += intval($user_data[$i]['nuke_user_posts']);
}

$content->init_math('nuke_user_posts', $user_data[0]['nuke_user_posts'], $total_posts_thisweek);
