...
$sql = "SELECT SUBSTRING_INDEX(nuke_user_regdate,' ',-1) as year_regdate, SUBSTRING_INDEX(nuke_user_regdate,' ',1) as month_regdate, COUNT(*) AS num_user
FROM " . USERS_TABLE . "
WHERE (user_id <> " . ANONYMOUS . " )
AND SUBSTRING_INDEX(nuke_user_regdate, ' ',1) <> 'Non'
GROUP BY SUBSTRING_INDEX(nuke_user_regdate,' ',-1), SUBSTRING_INDEX(nuke_user_regdate,' ',1)";
