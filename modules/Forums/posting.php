...
/*****[BEGIN]******************************************
 [ Mod:     Post Icons                         v1.0.1 ]
 ******************************************************/			
				$select_sql = ( !$submit ) ? ", t.topic_title, t.topic_icon, p.enable_bbcode, p.enable_html, p.enable_smilies, p.enable_sig, p.post_username, p.post_time, pt.post_subject, p.post_icon, pt.post_text, pt.bbcode_uid, u.username, u.user_id, u.nuke_user_sig" : '';
/*****[END]********************************************
 [ Mod:     Post Icons                         v1.0.1 ]
 ******************************************************/
 ...
 ******************************************************/
		...
		{
			if(!isset($post_info['nuke_user_sig_bbcode_uid']))
            $post_info['nuke_user_sig_bbcode_uid'] = '';
 ...
 ******************************************************/
				...
				if( $attach_sig && $nuke_user_sig != '' && $userdata['nuke_user_sig_bbcode_uid'] )
				{
						...
						$nuke_user_sig = bbencode_third_pass($nuke_user_sig, $userdata['nuke_user_sig_bbcode_uid'], $valid);
				}
