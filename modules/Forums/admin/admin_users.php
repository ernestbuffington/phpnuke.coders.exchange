 ...
 *****************************************************/
                $nuke_user_posts = ( empty($_POST['nuke_user_posts']) ) ? 0 : trim(strip_tags( (string) $_POST['nuke_user_posts'] ) );
/*****[END]********************************************
 [ Mod:    Edit User Post Count                v1.0.0 ]
 *****************************************************/
 /*****[BEGIN]******************************************
...
/*****[END]********************************************
 [ Mod:    Force Word Wrapping - Configurator v1.0.16 ]
 ******************************************************/
                $nuke_user_lang = $_POST['language'] ?: $board_config['default_lang'];
                $nuke_user_timezone = ( isset( $_POST['timezone']) ) ? (float) $_POST['timezone'] : $board_config['board_timezone'];
/*****[BEGIN]******************************************
 ...
 ******************************************************/
                ...
                $nuke_user_rank = ( empty($_POST['nuke_user_rank']) ) ? 0 : (int) $_POST['nuke_user_rank'];
/*****[BEGIN]******************************************
...
/*****[BEGIN]******************************************
 [ Mod:    Edit User Post Count                v1.0.0 ]
 *****************************************************/
                        $nuke_user_posts = (int) stripslashes($nuke_user_posts);
/*****[END]********************************************
 [ Mod:    Edit User Post Count                v1.0.0 ]
 *****************************************************/
 ...
 ******************************************************/
            ...
            if (isset($_POST['avatardel'])) {
                if( $this_userdata['nuke_user_avatar_type'] == USER_AVATAR_UPLOAD && $this_userdata['user_avatar'] != "" && file_exists(phpbb_realpath('./../' . $board_config['avatar_path'] . "/" . $this_userdata['user_avatar'])) )
                {
 ...
 ******************************************************/
                    ...
                    $sql = "UPDATE " . USERS_TABLE . "
								...
								nuke_user_sig = '" . str_replace("\'", "''", (string) $signature) . "', 
								...
								nuke_user_sig_bbcode_uid = '".$signature_bbcode_uid."', 
								...
								nuke_user_notify_pm = '".$notifypm."', 
								user_popup_pm = '".$popuppm."', 
								user_wordwrap = '".$user_wordwrap."', 
								nuke_user_lang = '" . str_replace("\'", "''", (string) $nuke_user_lang) . "', 
								theme = '".$nuke_user_style."', 
								nuke_user_timezone = '".$nuke_user_timezone."', 
								user_time_mode = '".$time_mode."', 
								user_dst_time_lag = '".$dst_time_lag."', 
								nuke_user_dateformat = '" . str_replace("\'", "''", (string) $nuke_user_dateformat) . "', 
...
/*****[BEGIN]******************************************
 [ Mod:    Edit User Post Count                v1.0.0 ]
 *****************************************************/
                    $nuke_user_posts = (int) stripslashes((string) $nuke_user_posts);
/*****[END]**********77********************************
 [ Mod:    Edit User Post Count                v1.0.0 ]
 *****************************************************/
 /*****[BEGIN]******************************************
 ...
 ******************************************************/
            ...
            /*****[BEGIN]******************************************
             [ Mod:    Edit User Post Count                v1.0.0 ]
             *****************************************************/
            $nuke_user_posts = (int) $this_userdata['nuke_user_posts'];
            /*****[END]********************************************
             [ Mod:    Edit User Post Count                v1.0.0 ]
             *****************************************************/
            /*****[BEGIN]******************************************
            ...
            {
                $value = ($this_userdata['nuke_user_sig_bbcode_uid'] != '') ? preg_replace('#:' . $this_userdata['nuke_user_sig_bbcode_uid'] . '#si', '', (string) $value) : $value;
...
/*****[BEGIN]******************************************
 [ Mod:    Edit User Post Count                v1.0.0 ]
 *****************************************************/
                        $s_hidden_fields .= '<input type="hidden" name="nuke_user_posts" value="' . $nuke_user_posts . '" />';
/*****[END]********************************************
 [ Mod:    Edit User Post Count                v1.0.0 ]
 *****************************************************/
 /*****[BEGIN]******************************************
...
/*****[BEGIN]******************************************
 [ Mod:    Multiple Ranks And Staff View       v2.0.3 ]
 ******************************************************/
				$selected1 = ( $this_userdata['nuke_user_rank'] == '-2' ) ? ' selected="selected"' : '';
				...
				$selected1 = ( $this_userdata['nuke_user_rank'] == '-1' ) ? ' selected="selected"' : '';
				...
				$selected1 = ( $this_userdata['nuke_user_rank'] == '0' ) ? ' selected="selected"' : '';
...
/*****[BEGIN]******************************************
 [ Mod:    Multiple Ranks And Staff View       v2.0.3 ]
 ******************************************************/
						$selected1 = ( $this_userdata['nuke_user_rank'] == $rank_id ) ? ' selected="selected"' : '';
 ...
 ******************************************************/
                $template->assign_vars([
                    ...
                    'L_USER_POSTS' => $lang['nuke_user_posts'],
                    /*****[END]********************************************
                     [ Mod:    Edit User Post Count                v1.0.0 ]
                     *****************************************************/
                    /*****[BEGIN]******************************************
