...
$override_nuke_user_style_yes = ( $new['override_nuke_user_style'] ) ? 'checked="checked"' : '';
$override_nuke_user_style_no = ( !$new['override_nuke_user_style'] ) ? 'checked="checked"' : '';
 ...
 ******************************************************/
    ...
    'OVERRIDE_STYLE_YES' => $override_nuke_user_style_yes,
    'OVERRIDE_STYLE_NO' => $override_nuke_user_style_no,
/*****[BEGIN]******************************************
 [ Mod:     Quick Search                       v3.0.1 ]
 ******************************************************/
