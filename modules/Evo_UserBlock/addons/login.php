...
else 
{
    ...
    $link1 = " <a class=\"modules\" href=\"modules.php?name=Image_Repository\" target=\"_self\"> ".$icon1." ".$lang_evo_userblock['BLOCK']['LOGIN']['MYHOSTEDIMAGES']."</a>";
    ...
    $link2 = " <a class=\"modules\" href=\"modules.php?name=Bookmarks\" target=\"_self\"> ".$icon2." ".$lang_evo_userblock['BLOCK']['LOGIN']['MYBOOKMARKS']."</a>";
    $evouserinfo_login .= '<div style="padding-left: 12px;">';
	$evouserinfo_login .= $link2."";
	$evouserinfo_login .= '</div>';

    $icon9 = " <i style=\"font-size: 18px; color: #adff2f;\" onMouseOver=\"this.style.color='#ECAB53'\" onMouseOut=\"this.style.color='#adff2f'\" class=\"bi bi-journal\"></i>";
    $link9 = " <a class=\"modules\" href=\"modules.php?name=Journal\" target=\"_self\"> ".$icon9." ".$lang_evo_userblock['BLOCK']['LOGIN']['MYJOURNAL']."</a>";
    $evouserinfo_login .= '<div style="padding-left: 10px;">';
	$evouserinfo_login .= $link9."";
	$evouserinfo_login .= '</div>';
    ...
    $link3 = " <a class=\"modules\" href=\"modules.php?name=Your_Account&op=chgtheme\" target=\"_self\"> ".$icon3." ".$lang_evo_userblock['BLOCK']['LOGIN']['CHANGEMYTHEME']."</a>";
    $evouserinfo_login .= '<div style="padding-left: 10px;">';
    ...
    $link4 = " <a class=\"modules\" href=\"modules.php?name=Profile&mode=viewprofile&u=".$userinfo['user_id']."\" target=\"_self\"> ".$icon4." ".$lang_evo_userblock['BLOCK']['LOGIN']['MYPROFILE']."</a>";
    ...
    $link5 = " <a class=\"modules\" href=\"modules.php?name=Profile\" target=\"_self\"> ".$icon5." ".$lang_evo_userblock['BLOCK']['LOGIN']['EDITMYPROFILE']."</a>";
    $evouserinfo_login .= '<div style="padding-left: 12px;">';
    ...
    $link6 = " <a class=\"modules\" href=\"modules.php?name=Your_Account&op=logout\" target=\"_self\"> ".$icon6." ".$lang_evo_userblock['BLOCK']['LOGIN']['LOGOUT']."</a>";
    $evouserinfo_login .= '<div style="padding-left: 12px;">';
    ...
    $link7 = " <a class=\"modules\" href=\"modules.php?name=Your_Account&op=delete\" target=\"_self\"> ".$icon7." ".$lang_evo_userblock['BLOCK']['LOGIN']['DELETE']."</a>";
    $evouserinfo_login .= '<div style="padding-left: 12px;">';
    ...
    $link8 = " <a class=\"modules\" href=\"modules.php?name=Your_Account&op=ShowCookiesRedirect\" target=\"_self\"> ".$icon8." ".$lang_evo_userblock['BLOCK']['LOGIN']['COOKIES']."</a>";
