...
function evouserinfo_get_members_online() 
{
   ...
   u.user_allow_viewonline, 
		  ...
		  u.user_viewemail, 
		    u.nuke_user_regdate, 
			  u.nuke_user_posts, 
				   ...
				   DESC, u.nuke_user_rank DESC, u.username";
    ...
    {   
        ...
        switch($session['nuke_user_avatar_type']):
        ...
        if ($evouserinfo_addons['online_tooltip'] == 'yes'):
			...
			$tooltip_userinfo_overlay .= '  <div class="user_tooltip">'.$lang_evo_userblock['BLOCK']['ONLINE']['SINCE'].'<span>'.$session['nuke_user_regdate'].'</span></div>';
			...
			<a href="modules.php?name=Forums&amp;file=search&amp;search_author='.$uname.'">'.$session['nuke_user_posts'].'</a></span></div>';
