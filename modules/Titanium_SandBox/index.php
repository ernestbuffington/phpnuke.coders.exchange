<?php
/*=======================================================================
 PHP-Nuke: Enhanced PHP-Nuke Web Portal System
 =======================================================================*/
/**
*
* This file is part of the Titanium SandBox package.
*
* @copyright (c) PHP-Nuke 2022 
...
$pagetitle = 'Titanium SandBox '.NUKE_VERSION;
$title = 'Titanium SandBox Module '.NUKE_VERSION;
...
{
  OpenTable();
  echo '<div align="center"><h1>Titanium SandBox '.NUKE_VERSION.'</h1></div>';
}
else
OpenTable();
#########################################################################	
...
<td align="left" width="100%" valign="top" >
		...
		. ' v'.NUKE_VERSION.' : This module is only for <strong>PHP-Nuke</strong> '
		...
		. 'to start learning PHP-Nuke, PHP, Java, cURL or just about any online programming language you can think of. There are no limits when it comes to The 86it Developers Network, they allow you full '
