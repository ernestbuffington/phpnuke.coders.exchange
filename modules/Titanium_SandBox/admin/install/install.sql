...
CREATE TABLE `nuke_bbadvanced_username_color` (
  `nuke_group_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
INSERT INTO `nuke_bbadvanced_username_color` (`nuke_group_id`, `group_name`, `group_color`, `group_weight`) VALUES
...
INSERT INTO `nuke_bbextensions` (`ext_id`, `nuke_group_id`, `extension`, `comment`) VALUES
(1, 1, 'gif', ''),
(2, 1, 'png', ''),
(3, 1, 'jpeg', ''),
(4, 1, 'jpg', ''),
...
INSERT INTO `nuke_bbextension_groups` (`nuke_group_id`, `group_name`, `cat_id`, `allow_group`, `download_mode`, `upload_icon`, `max_filesize`, `forum_permissions`) VALUES
...
INSERT INTO `nuke_bbgroups` (`nuke_group_id`, `group_type`, `group_name`, `group_description`, `group_moderator`, `group_single_user`, `group_allow_pm`, `group_color`, `group_rank`, `max_inbox`, `max_sentbox`, `max_savebox`, `override_max_inbox`, `override_max_sentbox`, `override_max_savebox`, `group_count`, `group_count_max`, `group_count_enable`) VALUES
...
INSERT INTO `nuke_bbuser_group` (`nuke_group_id`, `user_id`, `user_pending`) VALUES
(1, -1, 0),
(3, 2, 0),
(5, 2, 0),
(5, 3, 0);
...
(3, 'FreeDOS', 'http://sourceforge.net/export/rss2_projnews.php?nuke_group_id=5109'),
...
CREATE TABLE `nuke_users` (
  ...
  `nuke_user_timezone` decimal(5,2) NOT NULL DEFAULT '0.00',
  ...
  `nuke_user_notify_pm` tinyint(1) NOT NULL DEFAULT '1',
...
INSERT INTO `nuke_users` (`user_id`, `name`, `username`, `user_email`, `femail`, `user_website`, `user_avatar`, `nuke_user_regdate`, `user_occ`, `user_from`, `user_from_flag`, `user_interests`, `nuke_user_sig`, `user_viewemail`, `user_theme`, `user_facebook`, `user_password`, `storynum`, `umode`, `uorder`, `thold`, `noscore`, `bio`, `ublockon`, `ublock`, `theme`, `commentmax`, `counter`, `newsletter`, `nuke_user_posts`, `user_attachsig`, `nuke_user_rank`, `user_level`, `broadcast`, `popmeson`, `user_active`, `user_session_time`, `user_session_page`, `user_lastvisit`, `nuke_user_timezone`, `nuke_user_style`, `nuke_user_lang`, `nuke_user_dateformat`, `user_new_privmsg`, `user_unread_privmsg`, `user_last_privmsg`, `nuke_user_emailtime`, `user_allowhtml`, `user_allowbbcode`, `user_allowsmile`, `user_allowavatar`, `user_allow_pm`, `user_allow_mass_pm`, `user_allow_viewonline`, `user_notify`, `nuke_user_notify_pm`, `user_popup_pm`, `nuke_user_avatar_type`, `nuke_user_sig_bbcode_uid`, `user_actkey`, `user_newpasswd`, `points`, `last_ip`, `user_wordwrap`, `agreedtos`, `user_allowsignature`, `user_report_optout`, `user_show_quickreply`, `user_quickreply_mode`, `user_color_gc`, `user_color_gi`, `user_showavatars`, `user_showsignatures`, `user_time_mode`, `user_dst_time_lag`, `user_pc_timeOffsets`, `user_view_log`, `user_glance_show`, `user_hide_images`, `user_open_quickreply`, `sceditor_in_source`, `xdata_bbcode`, `user_ftr`, `user_ftr_time`, `user_rank2`, `user_rank3`, `user_rank4`, `user_rank5`, `user_gender`, `user_birthday`, `user_birthday2`, `birthday_display`, `birthday_greeting`, `user_next_birthday`, `user_reputation`, `user_rep_last_time`, `user_admin_notes`, `user_allow_arcadepm`) VALUES
