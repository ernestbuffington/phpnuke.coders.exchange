...
/*****[END]********************************************
 [ Mod:    Auto First User Login               v1.0.0 ]
 ******************************************************/
        $pnt_nuke_user_regdate = date('M d, Y');
        ...
        if (!mysqli_query($server_check, "INSERT INTO " . $_SESSION['user_prefix'] . "_users (`user_id`, `username`, `user_email`, `user_website`, `user_avatar`, `nuke_user_regdate`, `user_password`, `theme`, `commentmax`, `user_level`, `nuke_user_lang`, `nuke_user_dateformat`, `user_color_gc`, `user_color_gi`, `nuke_user_posts`) VALUES (NULL,'$pnt_user_nick','".$_POST['admin_email']."','".$url."','".$pnt_user_avatar."','".$pnt_nuke_user_regdate."','$pnt_user_pass','Titanium_Core','".$commentlimit."', '2', 'english','D M d, Y g:i a','d12727','--1--', '1')")){
			$error = true;
