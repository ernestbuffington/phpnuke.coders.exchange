 ...
 ******************************************************/
    ...
    themeblogarticle($userinfo['username'], UsernameColor($userinfo['username']),'','',$subject,$counter,$story,$topic,$topic,$topicimage,$topictext);
//	themeblogarticle(                 $aid,                           $informant, $datetime, $modified,   $title, $counter, $thetext, $topic,  $topicname, $topicimage, $topictext, $writes = false)
