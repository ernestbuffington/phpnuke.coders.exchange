...
define_once("_CLIENTPASSWD","Contraseña del Cliente");
...
define_once("_ALTTEXT","Texto Alterno");
define_once("_CLASS","Clase");
define_once("_CLASSNOTE","Si tu Clase de Banner es Código Javascript/HTML los siguientes 3 campos serán ignorados y sólo se tomará en cuenta el campo de código. Si tu Clase de Banner es Flash debes especificar el URL completo del archivo .SWF en el campo que sigue (Los campos URL para el Click y Texto Alterno serán ignorados.");
define_once("_ADCLASS","Class de Banner");
define_once("_ADIMAGE","Imagen");
define_once("_ADCODE","Código Javascript/HTML");
define_once("_ADFLASH","Flash");
define_once("_IMAGESIZE","Tamaño de Imagen");
define_once("_WIDTH","Ancho");
define_once("_HEIGHT","Alto");
define_once("_INPIXELS","(tamaño en pixels)");
define_once("_FLASHFILEURL","URL de Archivo Flash");
define_once("_FLASHSIZE","Tamaño del Flash");
...
define_once("_ADINFOINCOMPLETE","<b>Error:</b> Banner Information is Incomplete!");
...
define_once("_POSINFOINCOMPLETE","<b>Error:</b> Advertising position name field can't be empty.");
...
define_once("_ADSNOCLIENT","<b>Error:</b> There isn't any Advertising Client.<br>Please create a new client before add banners.");
...
define_once("_ADDPLANERROR","<b>Error:</b> One or more fields are empty. Please go back and correct the problem.");
...
define_once("_CANTDELETEPOSITION","<b>Error:</b> You can't delete ALL positions. At least one should be in the database.<br>Edit the position if you need to change it or add a new one.");
