...
define_once("_BANNERSADMIN","Bännerid");
define_once("_ACTIVEBANNERS","Praegu aktiivsed bannerid");
define_once("_ACTIVEBANNERS2","Aktiivsed bannerid");
define_once("_IMPRESSIONS","Näitamist");
define_once("_IMPLEFT","Näitamist järel");
define_once("_CLICKS","Klikke");
define_once("_CLICKSPERCENT","% Klikke");
define_once("_CLIENTNAME","Kliendi nimi");
define_once("_ADVERTISINGCLIENTS","Reklaami kliente");
define_once("_CONTACTNAME","Kontakti nimi");
define_once("_CONTACTEMAIL","Kontakti email");
define_once("_ADDNEWBANNER","Lisa uus banner");
define_once("_PURCHASEDIMPRESSIONS","Ostetud näitamist");
define_once("_IMAGEURL","Pildi URL");
define_once("_CLICKURL","Kliki URL");
define_once("_ADDBANNER","Lisa banner");
define_once("_ADDCLIENT","Lisa uus klient");
define_once("_CLIENTLOGIN","Kliendi logimine");
define_once("_CLIENTPASSWD","Kliendi salasõna");
define_once("_ADDCLIENT2","Lisa klient");
define_once("_DELETEBANNER","Kustuta banner");
define_once("_SURETODELBANNER","Oled sa kindel, et soovid kustutada seda Bannerit?");
define_once("_EDITBANNER","Redigeeri Bannerit");
define_once("_ADDIMPRESSIONS","Lisa rohkem näitamisi");
define_once("_DELETECLIENT","Kustuta reklaamitav klient");
define_once("_SURETODELCLIENT","Oled sa kindel, et soovid kustutada selle Klienti ja kõiki tema Bannereid!!!");
define_once("_CLIENTWITHOUTBANNERS","Sellel Kliendil pole käivitatud ühtegi Bannerit.");
define_once("_DELCLIENTHASBANNERS","Sellel kliendil on järgnevad AKTIIVSED BANNERID käivitatud");
define_once("_EDITCLIENT","Redigeeri reklaamitavat klienti");
...
define_once("_WARNING","Hoiatus");
define_once("_INACTIVEBANNERS","Deaktiivseid bannerid");
define_once("_BANNERS","Bannerid");
define_once("_ALTTEXT","Asendustekst");
