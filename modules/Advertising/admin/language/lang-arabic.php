...
define_once("_NO","áÇ");
define_once("_SAVECHANGES","ÍÝÙ ÇáÊÛííÑÇÊ");
define_once("_ID","ÑÞã");
define_once("_EXTRAINFO","ãÚáæãÇÊ ÇÖÇÝíÉ");
define_once("_SHOW","ÚÑÖ");
define_once("_BANNERSADMIN","ÞÇÆãÉ ÇáÏÚÇíÇÊ");
...
define_once("_IMPLEFT","ÇáÙåæÑ ÇáãÊÈÞí");
...
define_once("_ADDNEWBANNER","ÃÖÝ ÇÚáÇä ÌÏíÏ");
...
define_once("_ADDBANNER","ÃÖÝ ÃÚáÇä");
define_once("_ADDCLIENT","ÃÖÝ Úãíá ÌÏíÏ");
define_once("_CLIENTLOGIN","ÏÎæá ÇáÚãíá");
define_once("_CLIENTPASSWD","ßáãÉ ÓÑ ÇáÚãíá");
define_once("_ADDCLIENT2","ÃÖÝ Úãíá");
define_once("_DELETEBANNER","ÍÐÝ ÏÚÇíÉ");
define_once("_SURETODELBANNER","åá ÊÑíÏÍÐÝ åÐÇ ÇáÅÚáÇä ÈÇáÊÃßíÏ¿");
define_once("_EDITBANNER","ÊÍÑíÑ ÅÚáÇä");
define_once("_ADDIMPRESSIONS","ÃÖÝ ÚÏÏ ãÑÇÊ ÙåæÑ");
define_once("_DELETECLIENT","ÍÐÝ ÇáÚãíá");
define_once("_SURETODELCLIENT","ÃäÊ Úáì æÔß ÍÐÝ ÇáÚãíá ãÚ ÌãíÚ ÏÚÇíÇÊå!!!");
define_once("_CLIENTWITHOUTBANNERS","åÐÇ ÇáÚãíá áÇíæÌÏ áÏíå ÏÚÇíÇÊ ÍÇáíÇ.");
define_once("_DELCLIENTHASBANNERS","íæÌÏ áÏì åÐÇ ÇáÚãíá ÇáÏÚÇíÇÊ ÇáäÔØÉ ÇáÍÇáíÉ");
