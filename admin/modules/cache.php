...
function display_main() {
   ...
   //$closed = get_evo_icon('evo-sprite folder');
    ...
    foreach ($rii as $file) 
	{
	  ...
	  echo $open.' <span style="font-size:small; font-family: Times New Roman; color: lime;">'.$filedate.'</span>&nbsp;&nbsp;<span style="font-size:90%; font-family: Times New Roman; color: yellow;">'.$file.'</span></br>';
    }
