...
class utf_normalizer
{
	...
	*/
	public static function cleanup(&$str)
	{
		...
		{
			global $phpEx;
			include(NUKE_INCLUDE_DIR . 'utf/data/utf_nfc_qc.' . $phpEx);
		}

		if (!isset($GLOBALS['utf_canonical_decomp']))
		{
			global $phpEx;
			include(NUKE_INCLUDE_DIR . 'utf/data/utf_canonical_decomp.' . $phpEx);
		}
	...
	*/
	public static function nfkc(&$str)
	{
		...
		{
			global $phpEx;
			include(NUKE_INCLUDE_DIR . 'utf/data/utf_nfkc_qc.' . $phpEx);
		}

		if (!isset($GLOBALS['utf_compatibility_decomp']))
		{
			global $phpEx;
			include(NUKE_INCLUDE_DIR . 'utf/data/utf_compatibility_decomp.' . $phpEx);
		}
	...
	*/
	public static function recompose($str, $pos, $len, &$qc, &$decomp_map)
	{
		...
		{
			global $phpEx;
			include(NUKE_INCLUDE_DIR . 'utf/data/utf_normalizer_common.' . $phpEx);
		}
		...
		{
			global $phpEx;
			include(NUKE_INCLUDE_DIR . 'utf/data/utf_canonical_comp.' . $phpEx);
		}
