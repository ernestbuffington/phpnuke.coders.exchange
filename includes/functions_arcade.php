...
function get_arcade_categories($user_id, $user_level, $mode) {
        ...
        while($row = $db->sql_fetchrow($result)) {
          ...
          $sql = "SELECT aa.arcade_catid FROM " . AUTH_ARCADE_ACCESS_TABLE . " aa, " . USER_GROUP_TABLE . " ug, " . GROUPS_TABLE. " g WHERE ug.user_id = $user_id AND g.nuke_group_id = ug.nuke_group_id AND aa.nuke_group_id = ug.nuke_group_id ";
