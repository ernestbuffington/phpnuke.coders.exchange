 ...
 *                            -------------------
 *   Last Update          : Saturday', Mar 28', 2023
 ...
 *   Id: constants.php,v 4.0.4.0 2023/03/28 09:16 am TheGhost
 *
 ************************************************************************/
...
/*****[CHANGES]**********************************************************
-=[Mod]=-
      Recent Topics                            v1.2.5       03/28/2023
      Global Announcements                     v1.2.1       03/28/2023
      Quick Search                             v3.0.2       03/28/2023
      Staff Site                               v2.0.4       03/28/2023
      Forum ACP Administration Links           v1.0.1       03/28/2023
      Advanced Time Management                 v2.1.3       03/28/2023
      XData                                    v1.0.4       03/28/2023
      At a Glance Options                      v1.0.1       03/28/2023
      Initial Usergroup                        v1.0.2       03/28/2023
      Report Posts                             v1.2.4       03/28/2023
	  Member Country Flags                     v2.0.8       03/28/2023
	  Birthdays                                v3.0.1       03/28/2023
	  Thank You Mod                            v1.1.9       03/28/2023
	  Users Reputations Systems                v1.0.1       03/28/2023
	  Inline Banner Ad                         v1.2.4       03/28/2023
	  Email topic to friend                    v1.0.1       03/28/2023
	  Arcade                                   v3.0.3       03/28/2023
      Who viewed a topic                       v1.0.4       03/28/2023
 ************************************************************************/

if (!defined('IN_PHPBB') && !defined('NUKE_FILE')):
 die('Hacking attempt');
endif;
