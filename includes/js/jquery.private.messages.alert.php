...
if ( !defined('_disable_default_evo_pm_alert') ):
	...
	if (get_evo_option('pm_alert_status','int') == 1 && !isset($_COOKIE[get_evo_option('pm_cookie_name')]) && is_active('Private_Messages') == 1 && $name == '' && !defined('ADMIN_FILE') && $newpms > 0 && $userinfo['nuke_user_notify_pm'] == 1):
