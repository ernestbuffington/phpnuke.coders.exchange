...
//-- end: Ban List ----------------------------------------------------------//
						'log_new_user'			=> array('lang' => 'LOG_NEW_USER',			'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
						...
						//add userid in viewtopic mod
						'load_userid_viewtopic'	=> array('lang' => 'LOAD_USERID_VIEWTOPIC',	'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => false),
// end 
					)
				);
			break;
...
//-- end: Prime Quick Reply -------------------------------------------------//
				$display_vars = array(
					...
					'vars'	=> array(
						...
						//-- mod: Prime Quick Reply -------------------------------------------------//
						'legend3'				=> 'QUICK_REPLY_ADMIN_CATEGORY',
            ...
            case 'flag':
				$display_vars = array(
					...
					'vars'	=> array(
						...
						'require_flag'			=> array('lang' => 'REQUIRE_FLAG',	'validate' => 'bool',	'type' => 'radio:yes_no',	'explain' => true),
						'flags_path'			=> array('lang' => 'FLAGS_PATH',	'validate' => 'rpath',	'type' => 'text:20:255', 	'explain' => true),
					)
				);
			break;
