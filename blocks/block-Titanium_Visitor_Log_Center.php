...
/************************************************************************
   ...
   Notes         : Simple block to allow people to see who was last seen 
                 : on the website.
************************************************************************/
defined('NUKE_FILE') or die('Just go away, Shit Head!');
...
while($whosbeen = $db->sql_fetchrow($row1_result)):
	...
	$whosbeen['nuke_user_avatar_type'] = 4;
	$whosbeen['user_id'] = 1;
	endif;
	...
	if($whosbeen['nuke_user_avatar_type']):
	$whosbeen['nuke_user_avatar_type'] = str_replace('.png','',$whosbeen['nuke_user_avatar_type']);
	else:
	$whosbeen['nuke_user_avatar_type'] = '3';
	endif;
    ...
    {
	   switch($whosbeen['nuke_user_avatar_type'])
	   {
		# user_allowavatar = 1
