 ...
 * MysqlPConnectToMysqliConnectRector (https://stackoverflow.com/a/34041762/1348344)
 * MysqlQueryMysqlErrorWithLinkRector (https://www.php.net/manual/en/mysqli.error.php)
...
class sql_db
{
	...
	function sql_fieldname($offset, $query_id = 0)
	{
		...
		if($query_id)
		{
			$result = mysqli_fetch_field_direct($query_id, $offset)->name;
			return $result;
		}
		else
		{
	...
	function sql_fetchfield($field, $rownum = -1, $query_id = 0)
	{
		...
		if($query_id)
		{
			if($rownum > -1)
			{
               ...
               $fetch = mysqli_fetch_array($query_id);
               $result = $fetch[$field];
			}
			else
			{
